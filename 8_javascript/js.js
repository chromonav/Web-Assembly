...
var ASM_CONSTS = {
  14948: ($0, $1) => { alert('hello'); console.log('my number is', $0); console.log('my second number is', $1); return $0 +$1 + 3; }
};
function sayHi() { document.getElementById('hi').innerText = 'HI'; }
...
var ___start_em_js = Module['___start_em_js'] = 15060;
var ___stop_em_js = Module['___stop_em_js'] = 15118;
